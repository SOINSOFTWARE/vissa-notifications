...
public class VissaClient {
	...
	/**
	 * M�todo para obtener los productos a expirar
	 */
	private static void generateProductsToExpireReport() {
		...
		try {
			if (CommonsConstants.EXPIRATION_DAYS != null) {
				...
				log.error(strLog + "No hay d�as de validaci�n para fecha de vencimiennto configurados: "
						+ CommonsConstants.EXPIRATION_DAYS);
			}
	...
	/**
	 * M�todo para obtener los cuadres de caja de un d�a
	 */
